...
class GraphMLDataset(Dataset):
    def __init__(self, graph3d_dataset, surface_dataset, smile_input_dataset, config):
        self.smiles_input_dataset, self.graph_dataset, self.surface_dataset = \
            smile_input_dataset, graph3d_dataset, surface_dataset

        self.data_types = ['smiles_input','graph', 'surface']
